...
export const PIPELINE: StageDef[] = [
  ...
  { id: "encrypting",        label: "Securing workload",   blurb: "Provisions the workload volume; LUKS2-encrypted where the host supports it", onchain: false },
  { id: "executing",         label: "Executing",           blurb: "The workload runs inside its isolated container",              onchain: false },
